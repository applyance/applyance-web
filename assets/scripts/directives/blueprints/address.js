...
module.exports = angular.module('Apply')
  .directive('aplBlueprintAddress', ['BlueprintFactory', function(BlueprintFactory) {
    return {
      restrict: 'E',
      templateUrl: '/views/directives/blueprints/address.html',
      scope: {
        aplBlueprint: "="
      },
      link: function (scope, elm, attr) {
        ...
        scope.BF = new BlueprintFactory(scope.blueprint, {
          default: {
            country: _.find(scope.countries, function(country) {
              return country.code == 'US';
            }).code
          }
        });

        var entryKeys = ['street1', 'city', 'state', 'postal_code'];
